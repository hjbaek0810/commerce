module.exports = {
  siteUrl:
    ...
    'https://commerce-mini-mall.vercel.app', // .게시하는 site의 url
  ...
  exclude: ['/api/*', '/admin/*'], // sitemap 등록 제외 페이지 주소
  host:
    process.env.NEXT_PUBLIC_VERCEL_URL ||
    'https://commerce-mini-mall.vercel.app',
  sitemap: `${process.env.NEXT_PUBLIC_VERCEL_URL || 'https://commerce-mini-mall.vercel.app'}/sitemap.xml`,
  robotsTxtOptions: {
    // 정책 설정
    policies: [
      {
